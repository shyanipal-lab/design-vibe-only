...
export interface CinematicHeroProps extends React.HTMLAttributes<HTMLDivElement> {
  ...
  ctaPrimarySubtext?: string;
  ctaSecondaryText?: string;
  ctaSecondarySubtext?: string;
  cardColor?: string;
  className?: string;
}
...
export function CinematicHero({ 
  ...
  ctaPrimaryText = "App Store",
  ctaPrimarySubtext = "Download on the",
  ctaSecondaryText = "Google Play",
  ctaSecondarySubtext = "Get it on",
  cardColor = "#162C6D",
  className, 
  ...props 
}: CinematicHeroProps) {
      ...
      scrollTl
        ...
        .to(".counter-val", { 
          ...
          onUpdate: function() {
            ...
            const val = target.innerHTML.replace(/,/g, '');
            if (!isNaN(Number(val))) {
              target.innerHTML = Math.round(Number(val)).toLocaleString('en-IN');
            }
          }
        }, "-=2.0")
    ...
    >
      ...
      <div className="cta-wrapper absolute z-30 flex flex-col items-center justify-center text-center w-screen px-4 gsap-reveal pointer-events-auto will-change-transform">
        ...
        <div className="flex flex-col sm:flex-row gap-6">
          <a href="#" aria-label={ctaPrimaryText} className="btn-modern-light flex items-center justify-center gap-3 px-8 py-4 rounded-[1.25rem] group focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
            {ctaPrimaryText === "App Store" ? (
            ...
            <div className="text-left">
              <div className="text-[10px] font-bold tracking-wider text-neutral-500 uppercase mb-[-2px]">{ctaPrimarySubtext}</div>
              <div className="text-xl font-bold leading-none tracking-tight">{ctaPrimaryText}</div>
            </div>
          </a>
          <a href="#" aria-label={ctaSecondaryText} className="btn-modern-dark flex items-center justify-center gap-3 px-8 py-4 rounded-[1.25rem] group focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-background">
            {ctaSecondaryText === "Google Play" ? (
            ...
            <div className="text-left">
              <div className="text-[10px] font-bold tracking-wider text-neutral-400 uppercase mb-[-2px]">{ctaSecondarySubtext}</div>
              <div className="text-xl font-bold leading-none tracking-tight">{ctaSecondaryText}</div>
            </div>
          </a>
        </div>
      </div>
      ...
      <div className="absolute inset-0 z-20 flex items-center justify-center pointer-events-none" style={{ perspective: "1500px" }}>
        <div
          ...
          style={{ background: `linear-gradient(145deg, ${cardColor} 0%, #0A101D 100%)` }}
        >
          ...
          <div className="relative w-full h-full max-w-7xl mx-auto px-4 lg:px-12 flex flex-col justify-evenly lg:grid lg:grid-cols-3 items-center lg:gap-8 z-10 py-6 lg:py-0">
            ...
            <div className="card-right-text gsap-reveal order-1 lg:order-3 flex justify-center lg:justify-end z-20 w-full">
              <h2 className={cn(
                "font-black uppercase tracking-tighter text-card-silver-matte lg:mt-0",
                brandName.length > 8 ? "text-4xl md:text-[4rem] lg:text-[6rem]" : "text-6xl md:text-[6rem] lg:text-[8rem]"
              )}>
                {brandName}
              </h2>
            </div>
            ...
            <div className="mockup-scroll-wrapper order-2 lg:order-2 relative w-full h-[380px] lg:h-[600px] flex items-center justify-center z-10" style={{ perspective: "1000px" }}>
              ...
              <div className="relative w-full h-full flex items-center justify-center transform scale-[0.65] md:scale-85 lg:scale-100">
                        ...
                        <div className="phone-widget relative w-44 h-44 mx-auto flex items-center justify-center mb-8 drop-shadow-[0_15px_25px_rgba(0,0,0,0.8)]">
                          ...
                          <div className="text-center z-10 flex flex-col items-center">
                            <div className="flex items-baseline justify-center">
                              {metricPrefix && <span className="text-xl font-bold text-blue-200/80 mr-1">{metricPrefix}</span>}
                ...
                <div className="floating-badge absolute flex top-6 lg:top-12 left-[-15px] lg:left-[-80px] floating-ui-badge rounded-xl lg:rounded-2xl p-3 lg:p-4 items-center gap-3 lg:gap-4 z-30">
                  ...
                  <div>
                    <p className="text-white text-xs lg:text-sm font-bold tracking-tight">WhatsApp Links</p>
                    <p className="text-blue-200/50 text-[10px] lg:text-xs font-medium">Shared instantly</p>
                  </div>
                </div>
                ...
                <div className="floating-badge absolute flex bottom-12 lg:bottom-20 right-[-15px] lg:right-[-80px] floating-ui-badge rounded-xl lg:rounded-2xl p-3 lg:p-4 items-center gap-3 lg:gap-4 z-30">
                  ...
                  <div>
                    <p className="text-white text-xs lg:text-sm font-bold tracking-tight">Direct Sync</p>
                    <p className="text-blue-200/50 text-[10px] lg:text-xs font-medium">Bank account linked</p>
                  </div>
                </div>
            ...
            <div className="card-left-text gsap-reveal order-3 lg:order-1 flex flex-col justify-center text-center lg:text-left z-20 w-full lg:max-w-none px-4 lg:px-0">
              ...
              <p className="text-blue-100/70 text-xs md:text-base lg:text-lg font-normal leading-relaxed mx-auto lg:mx-0 max-w-sm lg:max-w-none">
                {cardDescription}
              </p>
            </div>
