...
export default function MercedesApp() {
  ...
  return (
    <div className="w-full h-full bg-white flex flex-col font-sans">
      ...
      <div className="flex-1 flex overflow-hidden">
        {/* Sidebar */}
        <div className="w-20 border-r border-zinc-100 flex flex-col items-center py-6 gap-6 bg-zinc-50/50">
          {tabs.map((tab) => (
            <button
              key={tab.id}
            ...
            >
              ...
              <div className="absolute left-full ml-4 px-2 py-1 bg-zinc-900 text-white text-[10px] font-bold uppercase tracking-widest rounded opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none whitespace-nowrap z-20">
                {tab.label}
              </div>
            </button>
          ))}
          ...
          <AnimatePresence mode="wait">
            {activeTab === "data" && (
              ...
              >
                <div className="flex items-center justify-between">
                  <h3 className="text-xl font-black uppercase tracking-tighter text-zinc-900">Unique ID Mapping</h3>
            ...
            {activeTab === "lang" && (
              ...
              >
                <div className="flex items-center justify-between">
                  <div>
                    <h3 className="text-xl font-black uppercase tracking-tighter text-zinc-900">Localization Engine</h3>
                    <p className="text-xs font-bold text-zinc-400 uppercase tracking-widest mt-1">150 Languages Supported</p>
                  </div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                  {LANGUAGES.map((lang) => (
                    <div key={lang} className="bg-white p-3 rounded-xl border border-zinc-100 flex items-center justify-between group hover:border-brand-primary transition-colors cursor-default">
                      <span className="text-xs font-bold text-zinc-600 group-hover:text-zinc-900">{lang}</span>
                ...
                <div className="bg-white p-6 rounded-2xl border border-zinc-100">
                  ...
                  <div className="flex flex-col gap-4">
                    <div className="p-4 bg-zinc-50 rounded-xl border border-zinc-100">
                      <p className="text-[10px] text-zinc-400 uppercase font-bold mb-1">Source (English)</p>
                      <p className="text-lg font-bold text-zinc-900 italic">"Welcome to the future of driving."</p>
                    </div>
                    ...
                    <div className="p-4 bg-brand-primary/5 rounded-xl border border-brand-primary/20">
                      <p className="text-[10px] text-brand-primary uppercase font-bold mb-1">Target (German)</p>
                      <p className="text-lg font-bold text-zinc-900 italic">"Willkommen in der Zukunft des Fahrens."</p>
                    </div>
                  </div>
                </div>
              </motion.div>
            ...
            {activeTab === "spec" && (
              <motion.div
                ...
                className="space-y-6"
              >
                <h3 className="text-xl font-black uppercase tracking-tighter text-zinc-900">Spec Design Mapping</h3>
                ...
                <div className="relative aspect-video bg-zinc-900 rounded-3xl overflow-hidden border border-zinc-800 shadow-2xl">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center p-12">
                    <div className="w-full h-full border border-white/10 rounded-2xl relative flex items-center justify-center">
                      <div className="w-48 h-48 rounded-full border-4 border-brand-primary flex flex-col items-center justify-center text-white relative">
                        <span className="text-4xl font-black tracking-tighter">120</span>
                        <span className="text-[10px] font-bold uppercase tracking-widest opacity-50">km/h</span>
                        
                        {/* Redlines */}
                        <div className="absolute -top-8 left-1/2 -translate-x-1/2 flex flex-col items-center">
                          <div className="w-[1px] h-8 bg-red-500" />
                          <div className="px-2 py-1 bg-red-500 text-white text-[8px] font-bold rounded">32px</div>
                        </div>
                        <div className="absolute top-1/2 -right-12 -translate-y-1/2 flex items-center">
                          <div className="px-2 py-1 bg-red-500 text-white text-[8px] font-bold rounded">48px</div>
                  ...
                  <div className="absolute bottom-6 left-6 right-6 flex justify-between items-end">
                    <div className="bg-white/10 backdrop-blur-md p-4 rounded-xl border border-white/10">
                      <p className="text-[10px] font-bold text-brand-primary uppercase mb-1">Component: Speedometer</p>
                      <p className="text-[8px] text-white/60 uppercase tracking-widest">Type: Dynamic SVG • Interaction: Real-time</p>
                    </div>
                    <div className="flex gap-2">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-white p-5 rounded-2xl border border-zinc-100">
                    <h4 className="text-xs font-bold uppercase tracking-widest text-zinc-900 mb-3">Typography Specs</h4>
                  ...
                  <div className="bg-white p-5 rounded-2xl border border-zinc-100">
                    <h4 className="text-xs font-bold uppercase tracking-widest text-zinc-900 mb-3">Spacing System</h4>
                    <div className="flex gap-2">
                      {[4, 8, 12, 16, 24, 32].map(s => (
                        <div key={s} className="flex flex-col items-center gap-1">
                          <div className="w-4 bg-brand-primary/20 rounded" style={{ height: `${s}px` }} />
                          <span className="text-[8px] font-bold text-zinc-400">{s}</span>
                        </div>
                      ))}
                    </div>
                  </div>
            ...
            {activeTab === "handover" && (
              ...
              >
                <div className="flex items-center justify-between">
                  <h3 className="text-xl font-black uppercase tracking-tighter text-zinc-900">Developer Handover</h3>
                  <button className="flex items-center gap-2 px-4 py-2 bg-zinc-900 text-white rounded-xl text-[10px] font-bold uppercase tracking-widest hover:bg-brand-primary transition-colors">
                ...
                <div className="space-y-4">
                  {COMPONENTS.map((comp) => (
                    <div key={comp.name} className="bg-white p-6 rounded-2xl border border-zinc-100 flex items-center justify-between group hover:border-brand-primary transition-colors">
                      <div className="flex items-center gap-4">
                        <div className="w-10 h-10 bg-zinc-50 rounded-xl flex items-center justify-center text-zinc-400 group-hover:text-brand-primary transition-colors">
                        ...
                        <div>
                          ...
                          <div className="flex gap-2 mt-1">
                            {comp.props.map(p => (
                              <span key={p} className="text-[8px] font-bold uppercase tracking-widest text-zinc-400 bg-zinc-50 px-1.5 py-0.5 rounded">{p}</span>
                            ))}
                          </div>
                        </div>
                      </div>
                      <div className="flex gap-2">
                        {comp.tokens.map(t => (
                          <span key={t} className="text-[8px] font-mono text-brand-primary bg-brand-primary/5 px-2 py-1 rounded-full border border-brand-primary/10">{t}</span>
                        ))}
                      </div>
                    </div>
                  ))}
                ...
                <div className="bg-zinc-900 rounded-2xl p-6 font-mono text-[10px] text-zinc-400 overflow-hidden">
  ...
  return <button className={styles}>{children}</button>;
            ...
            {activeTab === "bugs" && (
              ...
              >
                <div className="flex items-center justify-between">
                  <h3 className="text-xl font-black uppercase tracking-tighter text-zinc-900">Bug Tracking</h3>
                  <div className="flex gap-2">
                    ...
                    <button className="px-4 py-2 bg-zinc-50 text-zinc-400 rounded-xl text-[10px] font-bold uppercase tracking-widest border border-zinc-100">
                      4 Active Tickets
                    </button>
                  </div>
                </div>
                  ...
                  <table className="w-full text-left">
                    <thead>
                      <tr className="bg-zinc-50 border-b border-zinc-100">
                        ...
                        <th className="px-6 py-4 text-[10px] font-bold uppercase tracking-widest text-zinc-400">Issue</th>
                        <th className="px-6 py-4 text-[10px] font-bold uppercase tracking-widest text-zinc-400">Status</th>
                        <th className="px-6 py-4 text-[10px] font-bold uppercase tracking-widest text-zinc-400">Priority</th>
                      </tr>
                    </thead>
                    <tbody className="divide-y divide-zinc-50">
                      {TICKETS.map((ticket) => (
                        <tr key={ticket.id} className="hover:bg-zinc-50/50 transition-colors cursor-pointer group">
                          <td className="px-6 py-4 font-mono text-[10px] text-zinc-400">{ticket.id}</td>
                          <td className="px-6 py-4">
                            <div className="flex flex-col">
                              <span className="text-xs font-bold text-zinc-900 group-hover:text-brand-primary transition-colors">{ticket.title}</span>
                          ...
                          <td className="px-6 py-4">
                            <div className="flex items-center gap-2">
                              ...
                              <span className="text-[10px] font-bold text-zinc-600">{ticket.status}</span>
                            </div>
                          </td>
                          <td className="px-6 py-4">
                ...
                <div className="grid grid-cols-3 gap-4">
                  <div className="bg-white p-4 rounded-2xl border border-zinc-100 text-center">
                    <p className="text-2xl font-black text-zinc-900 tracking-tighter">12</p>
                    <p className="text-[8px] font-bold uppercase tracking-widest text-zinc-400">Bugs Found</p>
                  </div>
                  <div className="bg-white p-4 rounded-2xl border border-zinc-100 text-center">
                    <p className="text-2xl font-black text-green-600 tracking-tighter">8</p>
                    <p className="text-[8px] font-bold uppercase tracking-widest text-zinc-400">Resolved</p>
                  </div>
                  <div className="bg-white p-4 rounded-2xl border border-zinc-100 text-center">
                    <p className="text-2xl font-black text-blue-500 tracking-tighter">4</p>
                    <p className="text-[8px] font-bold uppercase tracking-widest text-zinc-400">Active</p>
                  </div>
                </div>
              </motion.div>
            )}
